...
const myuserdata = ()=>{
    axios.get("http://localhost:5400/Teachers").then((d)=>{
        console.log(d.data);
        b(d.data);
    })
...
const userDelete = (d)=>{
    console.log(d);
    axios.delete(`http://localhost:5400/Teachers/${d}`).then((r)=>{
    ...
    return (
        <div>
            <div className="flex justify-between items-center">
                <h1>List of users</h1>
                <button className='bg-blue-500 rounded p-1'><Link to="teacherreg">Add User</Link></button>
            </div>
            <div className="">
